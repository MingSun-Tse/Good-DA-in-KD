...
import math
from .util import mixup_process, get_lambda, to_one_hot, cutmix_process, data_augmentation_ensemble
import random
import numpy as np
...
class VGG(nn.Module):
    ...
    def forward_mixup(self, x, mix_mode='manifold_mixup', mixup_alpha=None, target=None, logit_t=None, mixup_output='logit', n_run=1, cut_size=16):
        # kd-Huan: mixup_hidden refers to: 
        # https://github.com/vikasverma1077/manifold_mixup/blob/870ef77caaa5092144d82c56f26b07b29eefabec/supervised/models/preresnet.py#L101
